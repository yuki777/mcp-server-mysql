...
npx -y @smithery/cli@latest install @benborla29/mcp-server-mysql@1.0.10 --client claude
```
...
```bash
npx @michaellatman/mcp-get@latest install @benborla29/mcp-server-mysql@1.0.10
```
...
```bash
# Using npm
npm install -g @benborla29/mcp-server-mysql@1.0.10

# Using pnpm
pnpm add -g @benborla29/mcp-server-mysql@1.0.10
```
